...
const Radio = props => {
  const {
    ...
    disabled
        ...
        restProps = _objectWithoutProperties(props, ["className", "checked", "onChange", "disabled"]);
  ...
  return /*#__PURE__*/_react.default.createElement(_checkBox.CheckboxRadioContainer, {
    className: className
  }, /*#__PURE__*/_react.default.createElement(HiddenRadio, _extends({
    ...
    disabled: disabled
  }, /*#__PURE__*/_react.default.createElement(Circle, null)));
};
