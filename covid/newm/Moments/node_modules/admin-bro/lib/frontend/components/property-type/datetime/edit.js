...
const Edit = props => {
  ...
  }, property.label), /*#__PURE__*/_react.default.createElement(_designSystem.DatePicker, _extends({
    value: value,
    disabled: property.isDisabled,
    onChange: data => onChange(property.name, data),
    propertyType: property.type
  }, property.custom)), /*#__PURE__*/_react.default.createElement(_designSystem.FormMessage, null, error && error.message));
};
