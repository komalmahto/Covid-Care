...
const SoftwareBrothers = () => /*#__PURE__*/_react.default.createElement(_designSystem.Box, {
  position: "absolute",
  left: 0,
  bottom: 5,
  right: 0
  ...
  variant: "sm",
  textAlign: "center"
}, "Made with", /*#__PURE__*/_react.default.createElement(_designSystem.Icon, {
  icon: "FavoriteFilled",
  color: "love",
  mx: "sm"
...
const Login = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(GlobalStyle, null), /*#__PURE__*/_react.default.createElement(Wrapper, {
    ...
    width: 82,
    height: 91
  }))), branding.softwareBrothers ? /*#__PURE__*/_react.default.createElement(SoftwareBrothers, null) : null), /*#__PURE__*/_react.default.createElement(_designSystem.Box, {
    as: "form",
    action: action,
    method: "POST",
    p: "x3",
    ...
    mb: "xl"
  }, branding.logo && /*#__PURE__*/_react.default.createElement(_designSystem.Box, {
    as: "img",
    src: branding.logo,
    ...
    mr: "lg",
    mt: "-3px"
  }), (_branding$companyName = branding.companyName) !== null && _branding$companyName !== void 0 ? _branding$companyName : 'AdminBro'), message && /*#__PURE__*/_react.default.createElement(_designSystem.MessageBox, {
    my: "lg",
