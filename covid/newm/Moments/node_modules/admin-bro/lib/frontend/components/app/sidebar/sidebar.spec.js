...
describe('<Sidebar />', function () {
  const renderTestSubject = (resources = [], branding = {}, pages = []) => {
    ...
    return (0, _reactTestingLibrary.render)( /*#__PURE__*/_react.default.createElement(_reactRedux.Provider, {
      store: store
    }, /*#__PURE__*/_react.default.createElement(_testContextProvider.default, null, /*#__PURE__*/_react.default.createElement(_sidebar.default, {
      isVisible: true
    }))));
  };
