...
const DropZoneItem = props => {
  ...
  return /*#__PURE__*/_react.default.createElement(_box.Box, {
    ...
    icon: "Attachment",
    mr: "default"
  }), src ? /*#__PURE__*/_react.default.createElement(DropZoneImg, {
    src: src
  }) : '', /*#__PURE__*/_react.default.createElement(_box.Box, {
    flexGrow: 1
  }, (file === null || file === void 0 ? void 0 : file.name) || filename), onRemove && /*#__PURE__*/_react.default.createElement(_button.Button, {
    variant: "text",
    m: "-8px",
    size: "icon",
    type: "button",
