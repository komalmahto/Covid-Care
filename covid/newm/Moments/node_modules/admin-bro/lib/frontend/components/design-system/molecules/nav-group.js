...
const NavGroup = props => {
  ...
  }, /*#__PURE__*/_react.default.createElement(NavGroupTitle, {
    onClick: () => toggleOpen(!isItOpen),
    bg: isItOpen ? 'grey20' : 'transparent'
  }, /*#__PURE__*/_react.default.createElement(_icon.Icon, {
    icon: icon || 'Settings'
  }), /*#__PURE__*/_react.default.createElement(_text.Text, null, title), /*#__PURE__*/_react.default.createElement(_icon.Icon, {
    icon: chevron
  })), isItOpen ? /*#__PURE__*/_react.default.createElement(_box.Box, {
    pl: "x3",
    pb: "xl",
    pt: "sm"
  }, children) : '');
