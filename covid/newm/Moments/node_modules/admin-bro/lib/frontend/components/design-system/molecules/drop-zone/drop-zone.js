...
const DropZone = props => {
  const {
    ...
    uploadLimitIn
        ...
        other = _objectWithoutProperties(props, ["validate", "onChange", "multiple", "files", "uploadLimitIn"]);
  ...
  return /*#__PURE__*/_react.default.createElement(_box.Box, null, /*#__PURE__*/_react.default.createElement(StyledDropZone, _extends({
    ...
    p: "xl"
  }), /*#__PURE__*/_react.default.createElement(UploadInput, {
    type: "file",
    onChange: event => onDrop(event),
    multiple: multiple
  }), /*#__PURE__*/_react.default.createElement(_box.Box, null, /*#__PURE__*/_react.default.createElement(_text.Text, {
    fontSize: "sm"
  }, "Pick or Drop File here to upload it."), /*#__PURE__*/_react.default.createElement(_box.Box, null, validate && validate.maxSize ? /*#__PURE__*/_react.default.createElement(_text.Text, {
    variant: "xs",
    color: "grey60",
    lineHeight: "default",
    mt: "sm"
    ...
    inline: true,
    uppercase: true
  }, "Max size:"), displayUploadLimit()) : '', validate && validate.mimeTypes && validate.mimeTypes.length ? /*#__PURE__*/_react.default.createElement(_text.Text, {
    variant: "xs",
    color: "grey60",
    lineHeight: "default",
    mt: "sm"
  }, validate.mimeTypes.join(', ')) : ''))), error ? /*#__PURE__*/_react.default.createElement(_messageBox.MessageBox, {
    mt: "default",
    variant: "danger",
    size: "sm",
    icon: "Warning",
