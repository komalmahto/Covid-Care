...
const H1 = (0, _styledComponents.default)(props => /*#__PURE__*/_react.default.createElement(Base, _extends({
  as: "h1"
}, props))).withConfig({
...
const H2 = (0, _styledComponents.default)(props => /*#__PURE__*/_react.default.createElement(Base, _extends({
  as: "h2"
}, props))).withConfig({
...
const H3 = Base;
exports.H3 = H3;
const H4 = (0, _styledComponents.default)(props => /*#__PURE__*/_react.default.createElement(Base, _extends({
  as: "h4"
}, props))).withConfig({
...
const H5 = (0, _styledComponents.default)(props => /*#__PURE__*/_react.default.createElement(Base, _extends({
  as: "h5"
}, props))).withConfig({
...
const H6 = (0, _styledComponents.default)(props => /*#__PURE__*/_react.default.createElement(Base, _extends({
  as: "h6"
}, props))).withConfig({
