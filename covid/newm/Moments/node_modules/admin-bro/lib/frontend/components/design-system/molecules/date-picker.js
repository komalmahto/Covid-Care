...
const DatePicker = props => {
  const {
    ...
    propertyType
        ...
        other = _objectWithoutProperties(props, ["value", "onChange", "disabled", "propertyType"]);
  ...
  if (value && value.constructor.name !== 'Date') {
    ...
    if (dateNum) {
      ...
      stringValue = (0, _dateUtils.formatDateProperty)(dateValue, propertyType);
    }
  } else if (value && value.constructor.name === 'Date') {
    stringValue = (0, _dateUtils.formatDateProperty)(value, propertyType);
  }

  const onDatePickerChange = date => {
    if (!disabled) {
      onChange((0, _dateUtils.formatDateProperty)(date, propertyType));
    }
  };

  return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement(Overlay, {
    onClick: () => setHidden(true),
    className: hidden ? 'hidden' : 'visible'
  }), /*#__PURE__*/_react.default.createElement(StyledDatePicker, {
    ...
    icon: "Calendar"
  })), !hidden ? /*#__PURE__*/_react.default.createElement(DatePickerWrapper, null, /*#__PURE__*/_react.default.createElement(_reactDatepicker.default, _extends({
    selected: dateValue,
