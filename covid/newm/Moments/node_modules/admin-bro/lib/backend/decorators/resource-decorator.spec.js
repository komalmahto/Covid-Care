...
describe('ResourceDecorator', function () {
  ...
  describe('#getResourceName', function () {
    it('returns resource when name is not specified in options', function () {
      expect(new _resourceDecorator.default(_objectSpread(_objectSpread({}, this.args), {}, {
        options: {}
  ...
  describe('#decorateProperties', function () {
    beforeEach(function () {
      ...
      this.decorator = new _resourceDecorator.default(_objectSpread(_objectSpread({}, this.args), {}, {
  ...
  describe('#getPropertyByKey', function () {
    beforeEach(function () {
      this.decorator = new _resourceDecorator.default(_objectSpread({}, this.args));
    });
  ...
  describe('#recordAction', function () {
    it('returns default actions', function () {
      const options = {};
      const actions = new _resourceDecorator.default(_objectSpread(_objectSpread({}, this.args), {}, {
        options
