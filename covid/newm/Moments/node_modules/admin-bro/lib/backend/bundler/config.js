...
const external = ['react', 'react-dom', 'redux', 'react-redux', 'flat', 'react-router', 'react-router-dom', 'react-datepicker', 'styled-components', 'styled-system', 'prop-types', 'admin-bro', // TODO remove next line in version 2.0, see comment in src/frontend/bundle-entry.jsx
'admin-bro/components', 'admin-bro/property-types', 'admin-bro/types', 'admin-bro/style', 'axios', 'recharts', '@carbon/icons-react', 'react-select/lib/Async', 'i18next', 'react-i18next'];
const globals = {
  react: 'React',
  redux: 'Redux',
  axios: 'axios',
...
const plugins = ({
  ...
  }, commonJSConfig)), babel(_objectSpread({
    extensions,
    babelrc: false,
